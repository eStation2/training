...
def thumbnail_view(filename, thumbFilename):
    ...
    qlDict = {
        ...
        "colorTable"    : "cgl_colorTable_FAPAR.txt",
        "ql_Subsample"  : [5,5],
        "ql_Min"        : 0,
        "ql_Max"        : 235,
        "ql_NDV"        : 255,
...
if __name__ == "__main__":
    ...
    for filepathname in date_fileslist:
        ...
        main_modify_XML(date_str, ql_filename, destination_xml, params_dict, xml_file_path = "CGLS_"+var_name+"300_V1_S3_ProductSet_PDF.xml" )
        ...
        # 4. (Optional) Verify the content of the created zip file
        # print("\nVerifying the content of the zip file:")
        # with zipfile.ZipFile(output_zip_name+'.zip', 'r') as zipf:
        #     zipf.printdir()
